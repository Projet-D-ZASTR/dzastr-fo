...
<template>
  <div class="w-full text-left">
    ...
    <h1 class="text-2xl font-semibold tracking-tight text-base-content sm:text-3xl">Sign in</h1>
    <p class="mt-2 max-w-md text-sm leading-relaxed text-base-content/65">
      Access your clients, invoices, and services from one place.
    </p>

    <form class="mt-8 space-y-5" @submit.prevent="submitLogin">
      <div class="form-control w-full">
        <label class="label py-0 pb-1.5" for="login-email">
      ...
      <div class="form-control w-full">
        <label class="label py-0 pb-1.5" for="login-password">
