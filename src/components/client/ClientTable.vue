...
const emit = defineEmits(['add-client', 'edit-client', 'delete-client', 'create-invoice', 'view-invoices'])
...
<template>
  <section class="flex w-full flex-col gap-3 sm:gap-4">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
      <div class="flex min-w-0 flex-col space-y-1">
        ...
        <p class="max-w-xl text-base font-medium leading-snug text-base-content/70 sm:text-lg">
          Gérez vos clients depuis ce tableau : modifiez une fiche, supprimez-la ou ouvrez une facture en un
          clic.
        </p>
      </div>
      <button
    ...
    <div
      class="card overflow-hidden border border-base-200 bg-base-100 shadow-sm"
    >
      <div
